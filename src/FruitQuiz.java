...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel(
				"<html>Which is not a real vegetable? <br> A: Tomato <br> B: Broccoli <br> C: Carrot</html>");
		question3 = new JLabel(
				"<html>How many letters are in the alphabet? <br> A: 25 <br> B: 26 <br> C: 27</html>");
